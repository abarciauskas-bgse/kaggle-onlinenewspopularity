...
The second approach we tries was various versions of logistic regression. We experimented with different variable selection and regularization approaches with moderate success. 
...
```
 ...
 \centerline{ \includegraphics[height=3in]{Rplot_keywords.jpeg} }
...
\centerline{ 
\includegraphics[height=3in]{Rplot1.jpeg}
}
...
Indeed, basic random forest specifications turned out to have around 51.5% test accuracy which is somewhat than the best regression models. 
...
\centerline{
\includegraphics[height=3in]{boost.pdf}
}
...
\centerline{
\includegraphics[height=3in]{ensemblecorr.png}
}
...
[1000 simulations]
\centerline{
\includegraphics[height=3in]{randomensemblesims.png}
}

[Accuracy by size]
\centerline{
\includegraphics[height=3in]{accuracybysamplesize.png}
}
...
\centerline{
\includegraphics[height=3in]{ntreesaccuracies.png}
}

[Accuracy by M-try]
\centerline{
\includegraphics[height=3in]{mtryaccuracies.png}
}
...
[Class Weighting Accuracy]
\centerline{
\includegraphics[height=3in]{classwtsaccuracies.png}
}
